/************************************************
 * UdcCudBtn.js
 * Created at 2021. 11. 19. 오전 10:34:27.
 *
 * @author student
 ************************************************/
...
function onBtn2Click(/* cpr.events.CMouseEvent */ e){
	...
	// 타입 지정 ctrl + shift + /
	/** @type cpr.controls.Grid */
	var vcGrd = app.getAppProperty("grid");
	
	// 선택한 행을 삭제 상태로 변경
	// ctrl + alt + l   -- 변수명 바로 지정
	var selectedRowIndex = vcGrd.getSelectedRowIndex();
	vcGrd.deleteRow(selectedRowIndex); 
